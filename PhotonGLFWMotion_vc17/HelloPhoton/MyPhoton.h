...
const unsigned char charCipherKey = 'a';
...
public:
	...
	void sendMyFloatData(void);
	void sendMyCharData(void);
	void sendMyStringData(std::string stringData);
	void sendMyByteData(const char* cstring, int stringSize);

private:
	std::string PlayerNames[20] = {  };
